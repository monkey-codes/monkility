...
public class MaxCountersTest {
    ...
    @Test
    public void itShouldCalculateCounters(){
        assertArrayEquals(new int[]{3,2,2,4,2}, maxCounters.solution(5, new int[]{3,4,4,6,1,4,4}));
        assertArrayEquals(new int[]{3,3,3,5,3}, maxCounters.solution(5, new int[]{3, 4, 4, 6, 1, 6, 4, 4}));
        assertArrayEquals(new int[]{1}, maxCounters.solution(1, new int[]{1}));
    }
}